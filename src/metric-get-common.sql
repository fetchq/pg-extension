...
DROP FUNCTION IF EXISTS fetchq_catalog.fetchq_metric_get_common(CHARACTER VARYING);
CREATE OR REPLACE FUNCTION fetchq_catalog.fetchq_metric_get_common(
	PAR_queue VARCHAR,
	OUT cnt INTEGER,
	OUT pnd INTEGER,
	OUT pln INTEGER,
...
BEGIN
	FOR VAR_q IN
		SELECT * FROM fetchq_catalog.fetchq_metric_get(PAR_queue)
	LOOP
