DROP FUNCTION IF EXISTS fetchq_catalog.fetchq_metric_set(CHARACTER VARYING, CHARACTER VARYING, INTEGER);
CREATE OR REPLACE FUNCTION fetchq_catalog.fetchq_metric_set(
	PAR_queue VARCHAR,
	PAR_subject VARCHAR,
	PAR_value INTEGER,
