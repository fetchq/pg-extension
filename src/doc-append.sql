...
DROP FUNCTION IF EXISTS fetchq_catalog.fetchq_doc_append(CHARACTER VARYING, JSONB, INTEGER, INTEGER);
CREATE OR REPLACE FUNCTION fetchq_catalog.fetchq_doc_append(
    PAR_queue VARCHAR,
    PAR_payload JSONB,
    PAR_version INTEGER,
...
BEGIN
    ...
    VAR_q = 'INSERT INTO fetchq_catalog.%s__documents(';
