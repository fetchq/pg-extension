...
DROP FUNCTION IF EXISTS fetchq_catalog.fetchq_queue_set_errors_retention(CHARACTER VARYING, CHARACTER VARYING);
CREATE OR REPLACE FUNCTION fetchq_catalog.fetchq_queue_set_errors_retention(
	PAR_queue VARCHAR,
