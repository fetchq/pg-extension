...
DROP FUNCTION IF EXISTS fetchq.queue_set_errors_retention(CHARACTER VARYING, CHARACTER VARYING);
CREATE OR REPLACE FUNCTION fetchq.queue_set_errors_retention(
	PAR_queue VARCHAR,
