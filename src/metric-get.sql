...
DROP FUNCTION IF EXISTS fetchq_catalog.fetchq_metric_get(CHARACTER VARYING, CHARACTER VARYING);
CREATE OR REPLACE FUNCTION fetchq_catalog.fetchq_metric_get(
	PAR_queue VARCHAR,
	PAR_subject VARCHAR,
...
DROP FUNCTION IF EXISTS fetchq_catalog.fetchq_metric_get(CHARACTER VARYING);
CREATE OR REPLACE FUNCTION fetchq_catalog.fetchq_metric_get(
	PAR_queue VARCHAR
) RETURNS TABLE(
	metric VARCHAR,
